...
export class Backend implements backendInterface {
    ...
    async createResume(arg0: string, arg1: Resume): Promise<void> {
    ...
    async getResumesByTemplate(arg0: string): Promise<Array<Resume>> {
        if (this.processError) {
            try {
                const result = await this.actor.getResumesByTemplate(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateResume(arg0: string, arg1: Resume): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateResume(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
